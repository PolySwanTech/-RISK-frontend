...
@Component({
  selector: 'app-select-risk-process',
  imports: [CommonModule, FormsModule, MatCardModule],
  templateUrl: './select-risk-process.component.html',
  styleUrl: './select-risk-process.component.scss'
})
export class SelectRiskProcessComponent {
